...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"baecce8e-a3da-4f0b-9dbb-0d8a7693fb25\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [22 x i8] c"com.companyname.ud5t1\00", align 16
...
@__DSOCacheEntry_name.34 = internal constant [20 x i8] c"libaot-UD5T1.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [458 x %struct.DSOCacheEntry] [
	...
	; 34
	%struct.DSOCacheEntry {
		i64 1576100373641944915, ; hash 0x15df6ef07549df53, from name: aot-UD5T1
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.34, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 35
	%struct.DSOCacheEntry {
	...
	; 60
	%struct.DSOCacheEntry {
		i64 2605319389514651958, ; hash 0x2427f42e62755936, from name: libaot-UD5T1.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.34, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 97
	%struct.DSOCacheEntry {
		i64 4021292176619390502, ; hash 0x37ce7fedcd74c626, from name: libaot-UD5T1
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.34, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 334
	%struct.DSOCacheEntry {
		i64 13639533807418652536, ; hash 0xbd495bbb851eb778, from name: UD5T1
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.34, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 440
	%struct.DSOCacheEntry {
		i64 18042497048253769095, ; hash 0xfa63d378de332587, from name: aot-UD5T1.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.34, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 446
	%struct.DSOCacheEntry {
		i64 18137520481486295985, ; hash 0xfbb56ac7fd5cd3b1, from name: UD5T1.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.34, i32 0, i32 0), ; name
		i8* null; handle
	}, 
